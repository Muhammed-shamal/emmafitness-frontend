...
export const metadata = {
    title: 'Emma Fitness Privacy Policy | Safeguarding Your Personal Information"',
    description: '&quot;Find the perfect gaming gear to enhance your gaming experience.&quot; encourages users to explore further and suggests the value proposition.',
}

function PrivacyPolicy() {
    return (
        <div class="container mx-auto p-4 text-xs md:text-sm " style={{ position: "relative", zIndex: 1 }}>
            <header class=" p-4 text-secondary">
                <h1 class="text-2xl font-semibold">Privacy Policy</h1>
            </header>
            <section class="bg-white rounded-lg shadow-lg p-6">
                <h2 class="text-xl font-semibold mb-4">Summary of Key Points</h2>

                <ul class="list-disc pl-6">
                    <li class="mb-2">What personal information do we process? <a href="#what-personal-information">Learn More</a></li>
                    <li class="mb-2">Sensitive Personal Information: We do not process sensitive personal information.</li>
                    <li class="mb-2">Do we receive any information from third parties? We do not receive information from third parties.</li>
                    <li class="mb-2">How do we process your information? <a href="#how-do-we-process">Learn More</a></li>
                    <li class="mb-2">In what situations and with which types of parties do we share personal information? <a href="#in-what-situations">Learn More</a></li>
                    <li class="mb-2">How do we keep your information safe? <a href="#how-do-we-keep">Learn More</a></li>
                    <li class="mb-2">What are your rights? <a href="#what-are-your-rights">Learn More</a></li>
                    <li class="mb-2">Exercising Your Rights: You can exercise your rights by contacting us directly or by filling out our data subject request form at <a href={basicData.email.slug}>{basicData.email.label}</a>. We will respond in accordance with applicable data protection laws.</li>
                </ul>
            </section>
            ...
            <section class="bg-white rounded-lg shadow-lg p-6">
                ...
                <ol class="list-decimal pl-6 space-y-2">
                    ...
                    <li><a href="#section-7">How Do We Handle Your Social Logins?</a></li>
                    <li><a href="#section-8">Is Your Information Transferred Internationally?</a></li>
                    ...
                    <li><a href="#section-14">Do California Residents Have Specific Privacy Rights?</a></li>
                    <li><a href="#section-15">Do Virginia Residents Have Specific Privacy Rights?</a></li>
            ...
            <section class="bg-white rounded-lg shadow-lg p-6" id="section-1">
                <h2 class="text-2xl font-semibold mb-4">1. What Information Do We Collect?</h2>

                <h3 class="text-xl font-semibold mb-2">Personal information you disclose to us</h3>
                <p>In Short: We collect personal information that you provide to us.</p>

                <p>We collect personal information that you voluntarily provide to us when you register on the Services, express an interest in obtaining information about us or our products and Services, when you participate in activities on the Services, or otherwise when you contact us.</p>

                <h3 class="text-xl font-semibold mt-4 mb-2">Personal Information Provided by You</h3>
                ...
                <h3 class="text-xl font-semibold mt-4 mb-2">Sensitive Information</h3>
                <p>We do not process sensitive information.</p>
            </section>


            <section class="bg-white rounded-lg shadow-lg p-6" id="section-2">
                <h2 class="text-2xl font-semibold mb-4">2. How Do We Process Your Information?</h2>
                ...
                <p>For a complete list of reasons and more details, please refer to our full privacy policy.</p>
            </section>



            <section class="bg-white rounded-lg shadow-lg p-6" id="section-3">
                <h2 class="text-2xl font-semibold mb-4">3. What Legal Bases Do We Rely On to Process Your Information?</h2>

                <p><strong>In Short:</strong> We only process your personal information when we believe it is necessary and we have a valid legal reason (i.e., legal basis) to do so under applicable law, like with your consent, to comply with laws, to provide you with services, to protect your rights, or to fulfill our legitimate business interests.</p>
                ...
                <ul class="list-decimal pl-6 space-y-2">
                    <li><strong>Consent:</strong> We may process your information if you have given us permission (i.e., consent) to use your personal information for a specific purpose. You can withdraw your consent at any time. <a href="#section-3-consent-learn-more">Learn More</a></li>
            ...
            <section class="bg-white rounded-lg shadow-lg p-6" id="section-4">
                <h2 class="text-2xl font-semibold mb-4">4. When and With Whom Do We Share Your Personal Information?</h2>
                ...
                <h3 class="text-xl font-semibold mb-2">Vendors, Consultants, and Other Third-Party Service Providers</h3>
                ...
                <h3 class="text-xl font-semibold mt-4 mb-2">Other sharing situations</h3>
                <p>We also may need to share your personal information in the following situations:</p>
                <ul class="list-disc pl-6">
                    <li>Business Transfers. We may share or transfer your information in connection with, or during negotiations of, any merger, sale of company assets, financing, or acquisition of all or a portion of our business to another company.</li>
                    <li>When we use Google Maps Platform APIs. We may share your information with certain Google Maps Platform APIs (e.g., Google Maps API, Places API). To find out more about Google`s Privacy Policy, please refer to this <a href="#section-4-google-maps-privacy">link</a>. We use certain Google Maps Platform APIs to retrieve certain information when you make location-specific requests. This includes: Delivery location; and other similar information. A full list of what we use information for can be found in this section and in the previous section titled &quot;HOW DO WE PROCESS YOUR INFORMATION?&quot;. We obtain and store on your device (&quot;cache&quot;) your location. You may revoke your consent anytime by contacting us at the contact details provided at the end of this document. The Google Maps Platform APIs that we use store and access cookies and other information on your devices. If you are a user currently in the European Economic Area (EU countries, Iceland, Liechtenstein, and Norway) or the United Kingdom, please take a look at our <a href="#section-4-cookie-notice">Cookie Notice</a>.</li>
                ...
                <p>Please note: Our location is in Dubai - UAE.</p>
            </section>



            <section class="bg-white rounded-lg shadow-lg p-6" id="section-5">
                <h2 class="text-2xl font-semibold mb-4">5. What Is Our Stance on Third-Party Websites?</h2>
                ...
                <p>The Services may link to third-party websites, online services, or mobile applications and/or contain advertisements from third parties that are not affiliated with us and which may link to other websites, services, or applications. Accordingly, we do not make any guarantee regarding any such third parties, and we will not be liable for any loss or damage caused by the use of such third-party websites, services, or applications. The inclusion of a link towards a third-party website, service, or application does not imply an endorsement by us.</p>

                <p>We cannot guarantee the safety and privacy of data you provide to any third parties. Any data collected by third parties is not covered by this privacy notice. We are not responsible for the content or privacy and security practices and policies of any third parties, including other websites, services, or applications that may be linked to or from the Services. You should review the policies of such third parties and contact them directly to respond to your questions.</p>
            </section>

            <section class="bg-white rounded-lg shadow-lg p-6" id="section-6">
                <h2 class="text-2xl font-semibold mb-4">6. Do We Use Cookies and Other Tracking Technologies?</h2>

                <p><strong>In Short:</strong> We may use cookies and similar tracking technologies (like web beacons and pixels) to access or store information. Specific information about how we use such technologies and how you can refuse certain cookies is set out in our <a href="#section-6-cookie-notice">Cookie Notice</a>.</p>
            </section>

            <section class="bg-white rounded-lg shadow-lg p-6" id="section-7">
                <h2 class="text-2xl font-semibold mb-4">7. How Do We Handle Your Social Logins?</h2>
            ...
            <section class="bg-white rounded-lg shadow-lg p-6" id="section-8">
                <h2 class="text-2xl font-semibold mb-4">8. Is Your Information Transferred Internationally?</h2>

                <p><strong>In Short:</strong> We may transfer, store, and process your information in countries other than your own.</p>

                <p>Our servers are located in the United States. If you are accessing our Services from outside the United States, please be aware that your information may be transferred to, stored, and processed by us in our facilities and by those third parties with whom we may share your personal information (see &quot;WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?&quot; above), in the United Arab Emirates, United States, and other countries.</p>
            ...
            <section class="bg-white rounded-lg shadow-lg p-6" id="section-9">
                <h2 class="text-2xl font-semibold mb-4">9. How Long Do We Keep Your Information?</h2>
            ...
            <section class="bg-white rounded-lg shadow-lg p-6" id="section-10">
                <h2 class="text-2xl font-semibold mb-4">10. How Do We Keep Your Information Safe?</h2>
            ...
            <section class="bg-white rounded-lg shadow-lg p-6" id="section-11">
                <h2 class="text-2xl font-semibold mb-4">11. Do We Collect Information From Minors?</h2>

                <p><strong>In Short:</strong> We do not knowingly collect data from or market to children under 18 years of age.</p>

                <p>We do not knowingly solicit data from or market to children under 18 years of age. By using the Services, you represent that you are at least 18 or that you are the parent or guardian of such a minor and consent to such minor dependent`s use of the Services. If we learn that personal information from users less than 18 years of age has been collected, we will deactivate the account and take reasonable measures to promptly delete such data from our records. If you become aware of any data we may have collected from children under age 18, please contact us at <span class="text-blue-500">[email address]</span>.</p>
            </section>

            <section class="bg-white rounded-lg shadow-lg p-6" id="section-12">
                <h2 class="text-2xl font-semibold mb-4">12. What Are Your Privacy Rights?</h2>
                ...
                <ul class="list-disc ml-6">
                    ...
                    <li>and, if applicable, to data portability</li>
                </ul>
            ...
            <section class="bg-white rounded-lg shadow-lg p-6" id="section-13">
                <h2 class="text-2xl font-semibold mb-4">13. CONTROLS FOR DO-NOT-TRACK FEATURES</h2>
            ...
            <section class="bg-white rounded-lg shadow-lg p-6" id="section-14">
                <h2 class="text-2xl font-semibold mb-4">14. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h2>
                ...
                <p>California Civil Code Section 1798.83, also known as the &quot;Shine The Light&quot; law, permits our users who are California residents to request and obtain from us, once a year and free of charge, information about categories of personal information (if any) we disclosed to third parties for direct marketing purposes and the names and address of all third parties with which we shared personal information in the immediately preceding calendar year. If you are a California resident and would like to make such a request, please submit your request in writing to us using the contact information provided below.</p>
            ...
            <section class="bg-white rounded-lg shadow-lg p-6" id="section-14">
                <h2 class="text-xl font-semibold mb-2">15. DO WE MAKE UPDATES TO THIS NOTICE?</h2>
                <p class="mb-4">
            ...
            <section class="bg-white rounded-lg shadow-lg p-6" id="section-14">
                <h2 class="text-xl font-semibold mb-2">16. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h2>
                <p class="mb-4">
                    Based on the applicable laws of your country, you may have the right to request access to the personal information we collect from you, change that information, or delete it. To request to review, update, or delete your personal information, please visit: <a href={basicData.email.slug}>{basicData.email.label}</a>.
                </p>
            </section>
