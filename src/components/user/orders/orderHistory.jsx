...
function OrderHistory() {
    ...
    useEffect(() => {
        const bring = async () => {
            ...
            const order = user?.userId &&   await fetchApi({ URI: `orders?filters[user]=${user?.userId}&populate=order_items.product.Feature_Photo&sort[updatedAt]=desc`, API_TOKEN: user?.token })
